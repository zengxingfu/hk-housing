...
let elder = {
  ...
  data: {
    ...
    datasets: [{
      ...
      borderColor: "rgb(253,134,36)",
      data: [
        14100, 17400, 19000, 26800, 32700, 37200, 41900, 36900, 37500, 38700, 42700, 51300, 63400, 87800, 111500, 126200, 140600, 134300, 128600
      ],
      fill: false,
      yAxisID: 'y-axis-1'
    }, {
      ...
      borderColor: "#3f51b5",
      data: [
        13, 16, 22, 29, 36, 41, 43, 38, 35, 35, 37, 40, 42, 46, 49, 51, 50, 47, 47
      ],
      fill: false,
      yAxisID: 'y-axis-2'
    }]
...
let vacancy = {
  ...
  data: {
    ...
    datasets: [{
      ...
      borderColor: "#3f51b5",
      data: [
        3, 5.1, 1.6, 1.04, 1.3, 1.7, 1.4, 1.3, 2.1, 1.4, 1.2, 1.3, 1.3, 0.8, 0.5, 0.6, 0.5
      ],
      fill: false
    }]
  },
